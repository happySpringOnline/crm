...
<%@ page import="com.happyballoon.crm.settings.domain.DicValue" %>
<%@ page import="java.util.Map" %>
<%@ page import="java.util.Set" %>
<%@ page import="com.happyballoon.crm.workbench.domain.Tran" %>
<%@page contentType="text/html;charset=UTF-8" language="java" %>
<%
	String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+request.getContextPath()+"/";

	//准备【字典类型为stage】的字典值列表
...
<body>
	...
	<div style="position: relative; left: 40px; top: -50px;">
        ...
        <%
			...
			//如果当前阶段的可能性不为0 前七个有可能是绿圈，绿色标记，黑圈，后两个一定是黑叉
			}else {
				//准备当前阶段的下标
				int index =0;
				for (int i = 0; i < dvList.size(); i++) {
        ...
        %>
                        ...
                        -----------
        <%
					//如果遍历出来的阶段的可能性不为0 说明前7个阶段 绿圈，绿色标记，黑圈
					}else {
						//如果是当前阶段
						if(i==index){
							//绿色标记-----------------------------
