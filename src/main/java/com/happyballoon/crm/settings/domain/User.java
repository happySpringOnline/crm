package com.happyballoon.crm.settings.domain;
...
public class User {
    ...
    /*
        ...
        我们在市场上常用的有两种方式
        日期：年月日
            yyyy-MM-dd  10位定长字符串（char）
        日期 + 时间：年月日时分秒  19位定长字符串（char）
            yyyy-MM-dd HH:mm:ss
     */
    /*
        关于登录
            ...
            user对象为null，说明账户密码错误
            如果user对象不为null，说明账户密码正确
    ...
    private String id;  //编号 主键 uuid 32
