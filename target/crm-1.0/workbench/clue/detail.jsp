...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#aname").keydown(function (event) {
			//回车键的话，开始查询
			if(event.keyCode==13){
				//alert("查询该线索尚未关联的市场活动,根据市场活动名字的关键字模糊查找");
        ...
        $("#addRemark").click(function () {
            ...
            $.ajax({
				...
				success:function (data) {
					/*
					data
						{success:"true/false",data:clueRemark}
					 */
					if (data.success){
						//添加成功后，清空文本框
						$("#remark").val("")
	...
	function editRemark(id) {
		...
		$("#editRemarkModal").on("shown.bs.modal",function (){
			$("#editRemarkModal #noteContent").focus();
		})
	...
	function showActivityList() {
		$.ajax({
			url:"workbench/clue/showActivityListByClueId.do",
			data:{
				"id":"${c.id}"
			},
			dataType:"JSON",
	...
	/*
	这里的id是一个线索关联的id,在showActivityList()已经处理过了
	 */
	function unbund(id) {
		$.ajax({
					...
					<div class="btn-group" style="position: relative; top: 18%; left: 8px;">
						<form class="form-inline" role="form">
						  <div class="form-group has-feedback">
						    <input type="text" id="aname" class="form-control" style="width: 300px;" placeholder="请输入市场活动名称，支持模糊查询11111">
