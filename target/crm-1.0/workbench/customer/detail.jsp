...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#updateRemarkBtn").click(function () {
			...
			$.ajax({
				...
				success:function (data) {
					...
					if(data.flag){
						//更新备注成功后
						$("#e"+remarkId).html(data.cr.noteContent)
						$("#s"+remarkId).html(data.cr.editTime+'&nbsp;由&nbsp;'+data.cr.editBy)
		...
		$("#saveRemarkBtn").click(function () {
			...
			$.ajax({
				url:"workbench/customer/saveCustomerRemarks.do",
				data:{
		...
		$("#addContact").click(function () {
			$.ajax({
				...
				success:function (data){
					...
					var userId = "${user.id}"
					$("#create-contactsOwner").val(userId)
		...
		showContactsList();
		//【展示交易列表】
		showTranByCustomerId();

	});
	//【展示交易列表】
	function showTranByCustomerId(){
		$.ajax({
			url:"workbench/customer/showTranListByCusId.do",
			data:{
				"customerId":"${customer.id}"
			},
			dataType:"JSON",
			...
			success:function (data) {
				...
				$.each(data,function (i,n) {
					html += '<tr>';
					html += '<td><a href="workbench/contacts/save.jsp" style="text-decoration: none;">${customer.name}-'+n.name+'</a></td>';
					html += '<td>'+n.money+'</td>';
					html += '<td>'+n.stage+'</td>';
	...
	function showContactsList() {
		$.ajax({
			url:"workbench/customer/showContactsListByCusId.do",
			data:{
				"customerId":"${customer.id}"
			},
			dataType:"JSON",
	...
	//【展示客户备注列表】
	function showCustomerRemarks() {
		$.ajax({
			url:"workbench/customer/showCustomerRemarks.do",
			data:{
				"id":"${customer.id}"
			},
			dataType:"JSON",
			...
			success:function (data) {
				...
				$.each(data,function (i,n) {
					...
					html += '<img title="${customer.id}" src="image/user-thumbnail.png" style="width: 30px; height:30px;">';
...
<body>
				...
				<div class="modal-body">
					<form class="form-horizontal" role="form">
						...
						<div class="form-group" style="position: relative;">
							...
							<div class="col-sm-10" style="width: 300px;">
								<input type="text" class="form-control" id="create-customerName" placeholder="${customer.name}" readonly>
							</div>
						</div>
	...
	<div style="position: relative; left: 40px; top: -30px;">
		<div class="page-header">
			<h3>${customer.name} <small><a href="#" target="_blank">${customer.website}</a></small></h3>
		</div>
	...
	<div>
		<div style="position: relative; top: 20px; left: 40px;">
			...
			<div>
				<a href="workbench/customer/addTranByCusId.do?customerId=${customer.id}" style="text-decoration: none;"><span class="glyphicon glyphicon-plus"></span>新建交易</a>
			</div>
		</div>
	</div>
	...
	<div>
		<div style="position: relative; top: 20px; left: 40px;">
			...
			<div>
				<a href="javascript:void(0);" id="addContact" style="text-decoration: none;"><span class="glyphicon glyphicon-plus"></span>新建联系人</a>
			</div>
		</div>
	</div>
